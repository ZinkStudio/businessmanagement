    ...
    protected static void insertClients() throws ServiceException {
        ...
        for (String nom : noms) {
            for (String homme : hommes) {
                ...
                clientService.save(new Client(null, nom, homme, Civilite.homme, fixe, mobile, email, secteur[0],
                        secteur[1], commentaires[rng.nextInt(commentaires.length)]));
            }
            ...
            for (String femme : femmes) {
                ...
                clientService.save(new Client(null, nom, femme, Civilite.femme, fixe, mobile, email, secteur[0],
                        secteur[1], commentaires[rng.nextInt(commentaires.length)]));
            }
        }
